...
Collects statistics from *.slurm.log files in a given directory: how far each
job got through its input file. For SLURM *resource* accounting (memory, CPU
time, walltime vs. what was requested) see collect_job_stats.py instead.
